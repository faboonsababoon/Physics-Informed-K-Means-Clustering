...
fileForTrain = pd.read_csv(r"C:\Users\surin\Documents\Other Files\irisTrainL9.csv")

fileForTest = pd.read_csv(r"C:\Users\surin\Documents\Other Files\irisTestL9.csv")
...
df = pd.DataFrame(fileForTrain)

newdf = pd.DataFrame(fileForTest)
...
print("Accuracy = " + str(correct / 120))
